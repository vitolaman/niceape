          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-200">
            <div className="space-y-8 text-gray-600">
              <div>
                ...
                <p>
                  By accessing and using NiceApe, you accept and agree to be bound by the terms and
              ...
              <div>
                ...
                <p>
                  ...
                  interruption) arising out of the use or inability to use the materials on NiceApe,
                  even if NiceApe or a NiceApe authorized representative has been notified orally or
                  in writing of the possibility of such damage. Because some jurisdictions do not
              ...
              <div>
                ...
                <p>
                  ...
                  does not imply endorsement by NiceApe of the site. Use of any such linked website
